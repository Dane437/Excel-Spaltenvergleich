...
difference_address = merge_nlz[merge_nlz['Stationsname'].fillna('') != merge_nlz['K3v'].fillna('')]    #eine leere Zelle zählt als Unterschied
only_address = difference_address[['Stationsname', 'K3v']]
